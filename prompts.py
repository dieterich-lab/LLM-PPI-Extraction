...
# system_prompt = "You are a top-tier molecular biologist specialized in the field of cardiology and molecular biology."
    ...
    "nerrel": {
        "oneshot": {
            "ppi": [
                ...
                "Look at the list of extracted proteins and use it to extract all the protein-protein interactions involved in signalling pathways from the text.",
            ],
            "tf": [
                "Please extract all transcription factors and genes from the text.",
                "Look at the list of extracted transcription factors and genes. Use it to extract all the relations involving transcription factors to the target genes they regulate from the text.",
            ],
        },
        "stepwise": {
            "ppi": [
