...
class PromptBuilder:
    ...
    SYSTEM_PROMPT = (
        "You are an expert molecular biologist specializing in protein-protein interactions. "
        "Your TASK is to extract protein-protein interactions from scientific texts with high precision. "
