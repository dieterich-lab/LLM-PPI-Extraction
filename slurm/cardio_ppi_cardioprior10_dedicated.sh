...
#SBATCH --job-name=cardio_ppi_cp10
#SBATCH --output=/beegfs/prj/LINDA_LLM/outputs/slurm/cardio_ppi_cp10_%j.log
...
OLLAMA_PORT="${OLLAMA_PORT:-11438}"
PORT_SUFFIX="${PORT_SUFFIX:-38}"
...
OLLAMA_LOG="${SLURM_LOG_DIR}/ollama_cardio_ppi_cp10_${SLURM_JOB_ID:-local}.log"
...
echo "Starting dedicated CardioPrior 10-paper PPI extraction"
echo "Model: $MODEL"
